...
head(pred)
confusionMatrix(arbolado_publico_mendoza_2021_validation$inclinacion_peligrosa,pred1)
confusionMatrix(pred1,arbolado_publico_mendoza_2021_validation$inclinacion_peligrosa)
mc <- with(arbolado_publico_mendoza_2021_validation,table(pred1, arbolado_publico_mendoza_2021_validation$inclinacion_peligrosa))
